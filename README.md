...
新任务的纯转写、AI 校验、人工批准与业务目录交付 SRT 统一采用无句读风格；版本号、`B-roll`、URL、邮箱和技术缩写中的词法符号会保留。无参考任务优先沿用 ASR/外部转写的合法时间边界，只在词级停顿、句末证据或 24 字硬限制能够证明更合适时拆分，不再为追求 8–18 字软目标重排整稿。Provider/raw 证据仍保持原样，历史任务不会被改写。
